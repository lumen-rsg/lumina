...
ScrollView {
    ...
    ColumnLayout {
        ...
        GridLayout {
            ...
            ControlTile { Layout.fillWidth: true; label: "Dark mode"; detail: Appearance.m3colors.darkmode ? "On" : "Off"; symbol: "dark_mode"; toggled: Appearance.m3colors.darkmode; onActivated: { const dark = !Appearance.m3colors.darkmode; Appearance.selectTheme("cassiopeia"); Config.options.appearance.dark = dark; } }
